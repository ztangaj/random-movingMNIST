...
if __name__ == '__main__':
    ...
    # The 'motion' argument is the type of motion - "vertical", "horizontal", "circular_clockwise", "circular_anticlockwise", "zigzag", "tofro"
    ...
    parser.add_argument('--rand_speed', dest='speed', action=argparse.BooleanOptionalAction, default=False)
    ...
    if num_gifs < 2*num_combinations:
        for i in range(num_gifs):
            ...
            mnist.main(digits=digits, motions=motions, dest=dest, random_speed=random_speed)
